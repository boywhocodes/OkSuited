...
user1 = User.create!({
  ...
  age: 24,
  gender: "female",
  eating_speed: "Average Paced Eater",
  image_url: "http://res.cloudinary.com/boywhocodes/image/upload/v1503521804/puddingpepper_djaxy9.jpg",
...
user2 = User.create!({
  ...
  image_url: "http://res.cloudinary.com/boywhocodes/image/upload/v1503521808/scurry23_rfvsgl.jpg",
...
user3 = User.create!({
  ...
  gender: "female",
  eating_speed: "Average Paced Eater",
  image_url: "http://res.cloudinary.com/boywhocodes/image/upload/v1503521807/bedheadredhead_gid7tm.jpg",
  summary: "Living my life one meal at a time :)",
  five_foods: "Oranges, grapes, acai, oatmeal, strawberries",
  three_faves: "I'm all about Peet's Coffee.  La Cantina is my faorite place to go after work.  Blue Hour has probably the best happy hour in the city.",
  daytime: "Copy writer for A&A Advertising",
...
user4 = User.create!({
  ...
  gender: "male",
  eating_speed: "Average Paced Eater",
  image_url: "http://res.cloudinary.com/boywhocodes/image/upload/v1503521808/phillthrill_i3a6gi.jpg",
...
user5 = User.create!({
  ...
  gender: "female",
  eating_speed: "Fast Eater",
  image_url: "http://res.cloudinary.com/boywhocodes/image/upload/v1503521842/greenmilkshake_dzl3cl.jpg",
...
user6 = User.create!({
  ...
  age: 64,
  gender: "male",
  eating_speed: "Leisurely Eater",
  image_url: "http://res.cloudinary.com/boywhocodes/image/upload/v1503521818/caviarjuggler_kdlyhw.jpg",
...
user7 = User.create!({
  ...
  gender: "male",
  eating_speed: "Average Paced Eater",
  image_url: "http://res.cloudinary.com/boywhocodes/image/upload/v1503521849/meteormatt_ytydku.jpg",
...
user8 = User.create!({
  ...
  gender: "female",
  eating_speed: "Average Paced Eater",
  image_url: "http://res.cloudinary.com/boywhocodes/image/upload/v1503521821/cheerytacos_sb2hik.jpg",
  summary: "Living my life one meal at a time :)",
  five_foods: "Oranges, grapes, acai, oatmeal, strawberries",
  three_faves: "I'm all about Peet's Coffee.  La Cantina is my faorite place to go after work.  Blue Hour has probably the best happy hour in the city.",
  daytime: "Copy writer for A&A Advertising",
  ...
  user9 = User.create!({
    ...
    gender: "male",
    eating_speed: "Leisurely Eater",
    image_url: "http://res.cloudinary.com/boywhocodes/image/upload/v1503521803/scottyknow_unsnw4.jpg",
  ...
  user10 = User.create!({
    ...
    gender: "female",
    eating_speed: "Leisurely Eater",
    image_url: "http://res.cloudinary.com/boywhocodes/image/upload/v1503521823/layseashell_qrvwje.jpg",
    summary: "I came for the food, I left with a full stomach and a happy soul.",
